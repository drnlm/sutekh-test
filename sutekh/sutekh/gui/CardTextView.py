...
import pango
import logging
from sutekh.core.generic.BaseObjects import IKeyword
from sutekh.SutekhUtility import format_text
from sutekh.gui.generic.BaseCardTextView import (BaseCardTextBuffer,
        BaseCardTextView)
...
class CardTextView(BaseCardTextView):
    ...
    def __init__(self, oController, oIconManager):
        super(CardTextView, self).__init__(oController, oIconManager,
                                           CardTextBuffer())
