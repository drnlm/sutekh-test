...
from ....io.DataPack import urlopen_with_timeout
...
from ..SutekhDialog import do_complaint_buttons
from ..AutoScrolledWindow import AutoScrolledWindow
from ....generic.Utility import ensure_dir_exists
...
class BaseImageFrame(BasicFrame):
    ...
    def _norm_cardname(self):
        ...
        raise NotImplementedError("implement _norm_cardname")
    ...
    def _make_card_url(self):
        """Return an url to attempt to download the card from."""
    ...
    def check_images(self, sTestPath=''):
        ...
        raise NotImplementedError("implement check_images")
...
class BaseImagePlugin(BasePlugin):
    ...
    def init_image_frame(self):
        ...
        if not self.oImageFrame:
            self.oImageFrame = self.cCardFrame(self)
    ...
    def setup(self):
        ...
        raise NotImplementedError("Implemented setup")

    def config_activate(self, _oMenuWidget):
        """Configure the plugin dialog."""
        raise NotImplementedError("Implemented config_activate")
