...
class BaseCountCardListCards(BasePlugin):
    ...
    def __init__(self, *args, **kwargs):
        super(BaseCountCardListCards, self).__init__(*args, **kwargs)
    ...
    def update_numbers(self):
        ...
        if self._oTextLabel:
            if self._iMode == self.NO_COUNT:
                ...
                dInfo = self._get_card_count_info()
            else:
                dInfo = self._get_exp_count_info()
    ...
    def _get_card_count_info(self):
        """Return count dictionary for card count case"""
        raise NotImplementedError("implemenet _get_card_count_info")

    def _get_exp_count_info(self):
        """Return count dictionary for count expansions case"""
        raise NotImplementedError("implemenet _get_card_count_info")

    def _do_load(self, aCards):
        """Heavy lifiting of the load implementation"""
        raise NotImplementedError("implemenet _do_load")
