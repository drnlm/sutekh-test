...
import gtk
from ....core.Objects import IPhysicalCardSet, IAbstractCard, PhysicalCardSet
from ....core.generic.BaseFilters import ParentCardSetFilter
...
class BaseCSIndependent(BasePlugin):
