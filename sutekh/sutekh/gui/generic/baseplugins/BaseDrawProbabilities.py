...
class BaseDrawSim(BasePlugin):
    ...
    def activate(self, _oWidget):
        ...
        oMainTitle = self._set_draw_size()
    ...
    def _get_card_counts(self, aSelectedCards):
        """Get the card counts from the model"""
    ...
    def _get_draw_label(self):
        """Extract the needed card info from the model"""
        raise NotImplementedError("Implement _get_draw_label")

    def _set_draw_size(self, oTitle):
        """Set draw size and add details of the draw in the dialog"""
        raise NotImplementedError("Implement _set_draw_size")
