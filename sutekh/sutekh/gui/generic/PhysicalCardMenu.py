...
class PhysicalCardMenu(CardListMenu):
    ...
    def create_edit_menu(self):
        ...
        sProfile = self._oMainWindow.config_file.get_profile(PHYS_CARDLIST,
                PHYS_CARDLIST)
        self._oCardlistProfileMenu = self._create_profile_menu(oMenu,
            "Cardlist Profile", PHYS_CARDLIST, self._select_cardlist_profile,
            sProfile)
    ...
    def _edit_profiles(self, _oWidget):
        ...
        oDlg = FrameProfileEditor(self._oMainWindow,
            self._oMainWindow.config_file, PHYS_CARDLIST)
        sCurProfile = self._oMainWindow.config_file.get_profile(PHYS_CARDLIST,
            PHYS_CARDLIST)
    ...
    def _fix_profile_menu(self):
        ...
        sProfile = self._oMainWindow.config_file.get_profile(PHYS_CARDLIST,
                PHYS_CARDLIST)
        self._update_profile_group(self._oCardlistProfileMenu, PHYS_CARDLIST,
    ...
    def _select_cardlist_profile(self, oRadio, sProfileKey):
        ...
        if oRadio.get_active():
            ...
            oConfig.set_profile(PHYS_CARDLIST, PHYS_CARDLIST, sProfileKey)
    ...
    def profile_option_changed(self, sType, _sProfile, sKey):
        ...
        if sType == PHYS_CARDLIST and sKey == 'name':
            self._fix_profile_menu()
