...
"""The base database definitions and pyprotocols adaptors"""
...
class BaseObjectMaker(object):
    ...
    def make_abstract_card(self, sCard):
        """Needs to be subclassed to do the right thing"""
    ...
    def make_card_type(self, sCardType):
        return self._make_object(CardType, ICardType, CardTypes, sCardType)
