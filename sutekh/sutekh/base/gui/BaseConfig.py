...
from validate import Validator, is_list, is_option
...
class BaseConfigFile(object):
    """Base class for the config file.
    ...
    def _get_app_configspec_file():
        """Get the config spec file"""
        # Subclasses will provide this
    ...
    def validate(self):
        ...
        fBaseConfigSpec = pkg_resources.resource_stream(__name__,
                                                        "baseconfigspec.ini")
        oConfigSpec = ConfigObj(fBaseConfigSpec, raise_errors=True,
        ...
        # Merge in overrides from the application
