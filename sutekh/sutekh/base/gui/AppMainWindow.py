...
class AppMainWindow(MultiPaneWindow):
    ...
    def __init__(self, cWriter, fIllegalFilter, fBestGuessFilter):
        ...
        self._fIllegalFilter = fIllegalFilter
        self._fBestGuessFilter = fBestGuessFilter
    ...
    def setup(self, oConfig, oCardTextFrame, oIconManager, oPluginManager):
        ...
        self._oCardLookup = GuiLookup(self._oConfig, self._fBestGuessFilter)
    ...
    def replace_with_physical_card_set(self, sName, oFrame, bDoReloadPCS=True,
        ...
        if oFrame:
            ...
            try:
                oPane = CardSetFrame(self, sName, self._fIllegalFilter(),
                                     self._cWriter, bStartEditable)
    ...
    def replace_with_physical_card_list(self, _oWidget, oOldFrame=None):
        ...
        if oOldFrame is None:
            oOldFrame = self._oFocussed
        oPane = PhysicalCardFrame(self, self._fIllegalFilter())
        self.replace_frame(oOldFrame, oPane)
        return oPane
