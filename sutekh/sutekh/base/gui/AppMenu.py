...
class AppMenu(SutekhMenu):
    ...
    def _add_download_menu(self, oDownloadMenu):
        ...
        if sqlhub.processConnection.uri() != "sqlite:///:memory:":
            ...
            self.create_menu_item("Import new Full Card List and"
    ...
    def _create_pane_menu(self):
        ...
        self._oAddHorzPane = self.create_menu_item("Split current pane"
                " _horizontally (|)", oMenu, self.add_pane_horizontal)
        self._oAddHorzPane.set_sensitive(False)

        self._oAddVertPane = self.create_menu_item("Split current pane"
        ...
        self._oDelPane = self.create_menu_item("_Remove current pane", oMenu,
    ...
    def _add_add_submenu(self, oMenuWidget):
        ...
        self._oAddPCLPane = self.create_menu_item("Add Full Card List",
                oAddMenu, self._oMainWindow.add_new_physical_card_list)
        self._oAddPCLPane.set_sensitive(True)

        self._oAddCardText = self.create_menu_item("Add Card Text Pane",
                oAddMenu, self._oMainWindow.add_new_card_text)
        self._oAddCardText.set_sensitive(True)

        self._oAddPCSListPane = self.create_menu_item("Add Card Set"
    ...
    def _add_replace_submenu(self, oMenuWidget):
        ...
        self._oReplacePCLPane = self.create_menu_item("Replace current pane"
                " with Full Card List", self._oReplaceMenu,
                self._oMainWindow.replace_with_physical_card_list)
        self._oReplacePCLPane.set_sensitive(True)

        self._oReplaceCardText = self.create_menu_item("Replace current pane"
                " with Card Text Pane", self._oReplaceMenu,
                self._oMainWindow.replace_with_card_text)
        self._oReplaceCardText.set_sensitive(True)

        self._oReplacePCSListPane = self.create_menu_item("Replace current"
                " pane with Card Set List", self._oReplaceMenu,
    ...
    def _add_about_dialog(oHelpMenu):
