...
"""Classes for managing and creating plugins."""
...
from .BaseConfig import CARDSET, FULL_CARDLIST, CARDSET_LIST, FRAME
...
class BasePluginManager(object):
    ...
    def _do_load_plugins(self, aPlugins):
        ...
        for sPluginName in submodules(aPlugins):
            ...
            if issubclass(cPlugin, self._cPluginBase):
