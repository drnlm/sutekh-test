...
from sutekh.base.core.BaseObjects import (AbstractCard, IAbstractCard,
                                          IExpansion, ICardType,
                                          IPhysicalCardSet, IRarityPair,
                                          IRarity, CardType, Expansion,
                                          RarityPair, PhysicalCardSet,
                                          PhysicalCard,
                                          MapPhysicalCardToPhysicalCardSet,
                                          Artist, Keyword, IArtist, IKeyword)

from sutekh.core.SutekhObjects import (SutekhAbstractCard, ICreed,
                                       IVirtue, IClan, IDiscipline, ITitle,
                                       ISect, Clan, Discipline, Title, Creed,
                                       Virtue, Sect, IDisciplinePair,
                                       CRYPT_TYPES)

from sutekh.base.core.BaseFilters import (IN, Filter, FilterBox, FilterAndBox,
                                          FilterOrBox, FilterNot, CachedFilter,
                                          NullFilter, NotNullFilter,
                                          SingleFilter, MultiFilter,
                                          DirectFilter, split_list,
                                          make_table_alias, ExpansionFilter,
                                          MultiExpansionFilter,
                                          ExpansionRarityFilter,
                                          MultiExpansionRarityFilter,
                                          CardTypeFilter, MultiCardTypeFilter,
                                          ArtistFilter, MultiArtistFilter,
                                          KeywordFilter, MultiKeywordFilter,
                                          CardNameFilter, PhysicalCardFilter,
                                          AbstractCardFilter,
...
# be tacked on here
PARSER_FILTERS = BASE_PARSER_LIST + [MultiCostTypeFilter, MultiClanFilter,
                                     MultiDisciplineFilter, MultiGroupFilter,
                                     MultiCapacityFilter, MultiCostFilter,
                                     MultiLifeFilter, MultiCreedFilter,
                                     MultiVirtueFilter, MultiSectFilter,
                                     MultiTitleFilter,
                                     MultiDisciplineLevelFilter,
                                     CardTextFilter, CardFunctionFilter,
                                     ]
